  ...
  return (
    ...
    >
      ...
      >
        <a
          href="#top"
          className="font-mono text-sm font-semibold tracking-tight text-foreground transition-colors hover:text-accent-soft"
        >
        ...
        {open && (
          ...
          >
            <div className="flex flex-col gap-1 px-5 py-4">
              ...
              <div className="mt-2 flex items-center gap-4 px-3 pb-2">
                <a
                  href={profile.github}
                  target="_blank"
                  rel="noopener noreferrer"
